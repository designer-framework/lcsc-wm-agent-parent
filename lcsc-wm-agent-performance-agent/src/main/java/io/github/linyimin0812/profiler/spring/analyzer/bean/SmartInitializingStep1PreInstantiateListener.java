...
public class SmartInitializingStep1PreInstantiateListener extends AbstractListener {
    ...
    private static final List<String> DEFAULT_LISTABLE_BEAN_FACTORY = Collections.singletonList("org.springframework.beans.factory.support.DefaultListableBeanFactory");
