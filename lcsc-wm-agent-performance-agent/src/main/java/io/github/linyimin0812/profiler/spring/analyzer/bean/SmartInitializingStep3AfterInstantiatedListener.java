...
public class SmartInitializingStep3AfterInstantiatedListener extends AbstractListener {
    ...
    private static final List<String> DEFAULT_SINGLETON_BEAN_REGISTRY = Collections.singletonList("com.designer");
    ...
    public boolean filter(String className) {
        return listenClassName().stream().anyMatch(className::startsWith);
    }
